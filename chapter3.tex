...
则称 $(X,Y)$ 服从二元正态分布, 记为 $(X,Y)\sim N(\mu_1,\mu_2,\sigma_1^2,\sigma_2^2,\rho)$. 其中五个参数的取值范围分别是：
  ...
  \end{property}
	...
	\end{example}
	\subsection{随机向量的数学期与协方差阵}\label{ssec:3.4.5}
	...
	有了条件分布密度函数的概念,  我们可以顺便给出连续随机变量场合的全概率公式和贝叶斯公式. 将式~\ref{eq:3.5.6} 和式~\ref{eq:3.5.8} 改写为
	\begin{align}
